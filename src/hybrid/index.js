...
const FEATURE_MAP={
  ...
  rules:{label:'Regeln',ico:'🔀',tab:'xtp-rules',fn:()=>document.querySelector('[onclick*="XT(this,\'xtp-rules\')"]')?.click()},
  case:{label:'Regeln',ico:'🔀',tab:'xtp-rules',fn:()=>document.querySelector('[onclick*="XT(this,\'xtp-rules\')"]')?.click()},
  ifelse:{label:'Regeln',ico:'🔀',tab:'xtp-rules',fn:()=>document.querySelector('[onclick*="XT(this,\'xtp-rules\')"]')?.click()},
  ...
  switch:{label:'Regeln',ico:'🔀',tab:'xtp-rules',fn:()=>document.querySelector('[onclick*="XT(this,\'xtp-rules\')"]')?.click()},
