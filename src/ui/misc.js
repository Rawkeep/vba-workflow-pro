...
const HELP_TIPS={
  ...
  'select-case':'<strong>Regeln (WENN/DANN)</strong> — Bedingte Logik mit UND/ODER.<br><br>Jede Regel kann mehrere Bedingungen \u00fcber verschiedene Spalten haben.<br>Jede Regel kann in eine <strong>eigene Zielspalte</strong> schreiben (\u2192 ZIEL pro Regel).<br><br>Im Ergebnis: <code>{Spaltenname}</code> kopiert den Wert aus einer anderen Spalte.<br>Operatoren: = \u2260 > < >= <= enth\u00e4lt beginnt endet leer nicht&nbsp;leer zwischen<br><br><strong>Tipp:</strong> Vorlagen nutzen f\u00fcr h\u00e4ufige Muster, Drag&amp;Drop f\u00fcr Priorit\u00e4t.',
  'if-else':'<strong>Regeln</strong> erstellt mehrstufige Bedingungen mit UND/ODER.<br><br>Beispiel: Wenn Land=DE UND Betrag>1000 \u2192 "Premium", sonst \u2192 "Standard"',
  'pipeline':'<strong>Pipeline</strong> verkettet mehrere Operationen automatisch nacheinander.<br><br>Beispiel: Filter \u2192 Sortieren \u2192 Regeln \u2192 Export \u2014 alles in einem Klick.',
